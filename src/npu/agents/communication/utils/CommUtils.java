...
public class CommUtils {
	public static enum MessageID {
		FB_STUCKED,FB_NEED_COLLABORATION,HUMAN_STUCKED,HUMAN_BLOCKED,AT_BLOCKED,AT_STUCKED,FB_BURIED,HUMAN_INJURED_SERIOUSLY,BUILDING_ON_FIRE, AT_BURIED,HUMAN_BURIED,CIVILIAN_BlOCKED,CIVILIAN_BURIED,CIVILIAN_INJURED,REFUGE_STUCK,REMOVE_AGENT, PF_INJURED,PF_BURIED,BUILDING_EXTINGUISHED, BUILDING_COLLAPSED, BUILDING_WARM, BUILDING_UNBURNT, BUILDING_CLEARED,BUILDING_HEATING,BUILDING_BURNING, BUILDING_INFERNO,CIVILIAN_LOCATION_BURIED, CIVILIAN_LOCATION_NOT_BURIED, HYDRANT_AVAILABLE, HYDRANT_OCCUPIED, REFUGE_FILLING_RATE, AFTER_SHOCK, ROAD_BLOCKED, EDGE_BLOCKED, ROAD_CLEARED, EDGE_CLEARED, ROAD_OCCUPIED, ROAD_BLOCKED_PRIORITIZED, FINISHED_CLUSTER_POLICE, FINISHED_CLUSTER_FIRE, FINISHED_CLUSTER_AMBULANCE, AGENT_LOCATION_HEARD_CIVILIAN, BURIED_AGENT_LOCATION, STUCK_INSIDE_BLOCKADE, CLUSTER_STATUS, ONE_CLUSTER_STATUS, REMOVE_ENTITY
	};
	/**
