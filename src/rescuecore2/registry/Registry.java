...
public final class Registry {
	...
	static {
		//TODO Register the ControlMessageFactory only once
		SYSTEM_REGISTRY
	...
	public void registerEntityFactory(EntityFactory factory) {
		//TODO 传过来的是StandardEntityFactory，所以调的是它的方法，它继承至AbstractEntityFactory，故最终调的是AbstractEntityFactory的方法
		for (String urn : factory.getKnownEntityURNs()) {
			//System.out.println("EntityFactory "+urn);
	...
	public void registerEntityFactory(String urn, EntityFactory factory) {
		synchronized (entityFactories) {
			...
			//给不同的标志符设置同一个工厂
			//System.out.println(factory.getClass().hashCode());
